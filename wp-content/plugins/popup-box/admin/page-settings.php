...
if ( isset( $param['test_mode'] ) && $param['test_mode'] == 'yes' ) {
	$default_test = '1';
}
...
$test_mode = array(
	...
	'attr'    => [
		'name'  => 'param[test]',
		'id'    => 'test_mode',
		'value' => isset( $param['test'] ) ? $param['test'] : $default_test,
	],
	'tooltip' => esc_attr__( 'If test mode is enabled, the popup will show for admin only', 'popup-box' ),
);

$status_mode = array(
	'label'   => esc_attr__( 'Activated', 'popup-box' ),
	'attr'    => [
		'name'  => 'status',
		'id'    => 'status',
		'value' => $status,
	],
	'tooltip' => esc_attr__( 'If check - the popup will show on the frontend. If uncheck - popup not displayed on the frontend.', 'popup-box' ),
);
                ...
                <div id="post-body-content" style="position: relative;">
                    <div id="titlediv" class="is-b-margin">
                        <div id="titlewrap">
                            <label class="screen-reader-text" id="title-prompt-text" for="title">
								<?php esc_attr_e( 'Enter title here', 'popup-box' ); ?>
                            </label>
                            <div class="field has-addons">
                                <div class="control is-expanded">
                                    <input class="input is-radiusless is-info" type="text"
                                           placeholder="<?php esc_attr_e( 'Register an item name', 'popup-box' ); ?>"
                    ...
                    <div class="live-preview">
                        <h3><span class="dashicons dashicons-admin-customizer"></span>
							<?php esc_html_e( 'Live Preview', 'popup-box' ); ?>
                        </h3>
                            ...
                            <div id="builder">
                                <div class="ds-popup" id="ds-popup">
                                    <div id="popup-wrapper" class="ds-popup-wrapper">
                                        <div class="ds-popup-content"></div>
                                    </div>
                                </div>
                            </div>
