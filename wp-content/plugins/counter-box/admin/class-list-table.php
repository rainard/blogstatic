...
class Wow_List_Table extends WP_List_Table {
	...
	private function table_data() {
		...
		if ( $result ) {
			foreach ( $result as $key => $value ) {
				...
				$tooltip_off    = esc_attr__( 'Click for Deactivate the counter.', $this->plugin['text'] );
				$tooltip_on     = esc_attr__( 'Click for Activate the counter.', $this->plugin['text'] );
	...
	public function get_bulk_actions() {
		$actions = array(
			...
			'activate-items'   => esc_attr__( 'Activate counter', $this->plugin['text'] ),
			'deactivate-items' => esc_attr__( 'Deactivate counter', $this->plugin['text'] ),
		);
