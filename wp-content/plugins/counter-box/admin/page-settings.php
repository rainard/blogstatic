...
$test_mode = array(
	...
	'tooltip' => esc_attr__( 'If test mode is enabled, the counter will show for admin only', $this->plugin['text'] ),
);
...
$status_mode = array(
	...
	'tooltip' => esc_attr__( 'If check - the counter will show on the frontend. If uncheck - counter not displayed on the frontend.', $this->plugin['text'] ),
);
