...
class WB_BSL_Stats
{
    ...
    public static function spider_404($num=10,$offset=0)
    {
        ...
        $sql = "SELECT SQL_CALC_FOUND_ROWS MAX(id) id,MAX(visit_date) visit_date, url,`code` FROM `{$wpdb->prefix}wb_spider_log` WHERE `code`=404 AND spider='Baiduspider' GROUP by url_md5 ORDER BY visit_date DESC $limit";
