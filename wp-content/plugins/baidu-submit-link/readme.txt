=== 多合一搜索自动推送管理插件-支持Baidu/Google/Bing/360/神马/头条 ===
Contributors: wbolt,mrkwong
Donate link: https://www.wbolt.com/
Tags: Baidu, URL, SEO, Bing, 360, Google
...
多合一搜索自动推送管理插件（原百度搜索推送管理插件）是一款针对WP开发的功能非常强大的百度、Google、Bing、360、神马和头条搜索引擎链接推送插件。协助站长将网站资源快速推送至各大搜索引擎，有利于提升网站的搜索引擎收录效率；该插件还提供文章百度收录查询功能。
...
1.2 **搜索推送统计**-支持按最近7天&30天快速查看百度搜索、Bing推送及360/神马/头条等搜索引擎站长平台推送数据统计。
...
> <strong>关于百度收录查询</strong>
>
> 由于百度搜索引擎经常更新反爬机制，无论是WordPress网站自身服务器还是使用插件提供的收录查询服务器，均会出现收录查询无结果问题。
>
> 因此，收录查询结果仅供参考。又或者站长可以通过手动标记的方式，以修正收录状态！
...
2.4 **其他推送日志**-支持查看360、神马和头条搜索站长平台推送的所有链接日志，包括日期、链接及推送状态，并支持一键清除日志。
...
* **（4）360推送推送设置**-支持贴入360站长平台生成的快速收录推送JS代码，实现数据自动推送至360平台；并且支持批量推送链接。

* **（5）神马推送推送设置**-支持贴入神马搜索站长平台生成的推送API接口调用地址，实现数据自动推送至神马搜索。
...
= 为什么文章收录状态一直显示检测中？ =
检测中即处于检测队列，由于数据量较大，新文章检测需要等候一定的时间。
