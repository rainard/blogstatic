...
Description: 多合一搜索自动推送管理插件（原百度搜索推送管理插件）是一款针对WP开发的功能非常强大的百度、谷歌、Bing、360、神马和头条搜索引擎链接推送插件。协助站长将网站资源快速推送至百度、Bing、360等各大搜索引擎，有利于提升网站的搜索引擎收录效率；该插件还提供文章百度收录查询功能。
Author: wbolt team
Version: 4.0.1
