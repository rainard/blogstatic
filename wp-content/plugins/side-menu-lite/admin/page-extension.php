...
<section class="section has-background-light is-medium" id="features">
    <div class="container">
        ...
        <div class="columns is-multiline is-variablefeature-boxes">
            ...
            <div class="column">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5">Next Post</p>
                        <p class="has-text-left">Link to the next post.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5">Previous Post</p>
                        <p class="has-text-left">Link to the previous post.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        ...
                        <p>Create item with search field.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5">Hold Label open</p>
                        <p>You can showing the item label open by page load.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5">Label Font</p>
                        <p>Set the font style and font weight.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5">Schedule</p>
                        <p>Add scheduling options to your menus. With multiple schedule types, you can precisely schedule your menu in just a few minutes.</p>
                    </div>
                </div>
            </div>
