        ...
        <div class="feature-section one-col">
            <div class="col">
                ...
                <p><?php printf( esc_attr__( 'To get your support related question answered in the fastest timing, please send a message via the form below or write to us on email %1$s',
						'side-menu' ), '<a href="mailto:helper@wow-company.com">helper@wow-company.com</a>' ); ?>
                    .</p>
                ...
                <form method="post" action="" class="wow-plugin">
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                <label class="label">
									<?php esc_html_e( 'First Name', 'side-menu' ); ?>
                                </label>
                                <div class="control is-expanded">
                                    <input type="text" class="input" name="wow-fname" value=""
                                           placeholder="<?php esc_html_e( 'Enter Your First Name', 'side-menu' ); ?>">
                                </div>
                            </div>
                        ...
                        <div class="column">
                            <div class="field">
                                <label class="label">
									<?php esc_html_e( 'Last Name', 'side-menu' ); ?>
                                </label>
                                <div class="control is-expanded">
                                    <input type="text" name="wow-lname" value="" class="input"
                                           placeholder="<?php esc_html_e( 'Enter Your Last Name', 'side-menu' ); ?>">
                                </div>
                            </div>
                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                <label class="label">
									<?php esc_html_e( 'Link to the page with issue', 'side-menu' ); ?>
                                </label>
                                <div class="control is-expanded">
                        ...
                        <div class="column">
                            <div class="field">
                                <label class="label">
									<?php esc_html_e( 'Contact email', 'side-menu' ); ?>
                                </label>
                                <div class="control is-expanded">
                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                <label class="label">
									<?php esc_html_e( 'License Key', 'side-menu' ); ?>
                                </label>
                                <div class="control is-expanded">
                                    <input type="text" class="input" disabled name="wow-license-key"
                                           value="<?php if ( ! empty( $license ) ) {
										       esc_attr_e( $license );
									       }; ?>">
                                </div>
                            </div>
                        ...
                        <div class="column">
                            <div class="field">
                                <label class="label">
									<?php esc_html_e( 'Plugin', 'side-menu' ); ?>
                                </label>
                                <div class="control is-expanded">
                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                <label class="label">
									<?php esc_html_e( 'Message type', 'side-menu' ); ?>
                                </label>
                                <div class="control is-expanded">
                                    <div class="select is-fullwidth">
                                        <select name="wow-message-type">
                                            <option value="Issue"><?php esc_html_e( 'Issue', 'side-menu' ); ?></option>
                                            <option value="Idea"><?php esc_html_e( 'Idea', 'side-menu' ); ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="columns">
                        <div class="column">
                            <input type="submit" class="button button-primary" name="action"
                                   value="<?php esc_html_e( 'Send to Support', 'side-menu' ); ?>">
                        </div>
                    </div>
