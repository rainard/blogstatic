                    ...
                    <div id="titlediv">
                        ...
                        <div id="titlewrap">
                            ...
                            <input type="text" class="input" name="title" size="30"
                                   ...
                                   placeholder="<?php esc_attr_e( 'Register an menu name', 'side-menu' ); ?>"
                                   autocomplete="off">
                        </div>
                ...
                <div id="postbox-container-1" class="postbox-container">
                    ...
                    <div id="submitdiv" class="box">
                        <h2 class="has-border-bottom">
							<?php esc_html_e( 'Publish', 'side-menu' ); ?>
                        </h2>
                                ...
                                <div class="column is-12">
                                    <div class="field">
                                        <label class="checkbox label">
											<?php self::option( $status ); ?><?php esc_attr_e( "Deactivated", 'side-menu' ); ?><?php self::tooltip( $status_help ); ?>
                                        </label>
                                    </div>
                                    <div class="field">
                                        <label class="checkbox label">
											<?php self::option( $test_mode ); ?><?php esc_attr_e( "Test mode", 'side-menu' ); ?><?php self::tooltip( $test_mode_help ); ?>
                                        </label>
                                    </div>
                                ...
                                <div id="delete-action">
									<?php if ( ! empty( $id ) ) : ?><?php $delete_url = admin_url() . 'admin.php?page=' . $this->plugin['slug'] . '&info=delete&did=' . absint( $id ); ?>
                                        <a class="submitdelete deletion"
                                           href="<?php echo esc_url( $delete_url ); ?>"><?php esc_attr_e( 'Delete', 'side-menu' ); ?></a>
									<?php endif; ?>
                                </div>

                                <div id="publishing-action">
                                    <span class="saving"><?php esc_html_e( 'Saving', 'side-menu' ); ?></span>
                    ...
                    <div class="upgrade-box">
                        <a class="button is-demo" href="https://wow-company.com/preview/wordpress-plugins/side-menu-pro/" target="_blank">Demo</a>
                                ...
                                <div class="tabs is-vertical" id="tab">
                                    <ul>
                                        <li class="is-active" data-tab="1">
                                            <a><?php esc_html_e( 'Menu', 'side-menu' ); ?></a>
                                        </li>
                                        <li data-tab="2">
                                            <a><?php esc_html_e( 'Settings', 'side-menu' ); ?></a>
                                        </li>
                                        <li data-tab="3">
                                            <a><?php esc_html_e( 'Display', 'side-menu' ); ?></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
