...
<div class="about-wrap">
  ...
  <h1><?php esc_attr_e( 'Welcome', 'herd-effects' ); ?> </h1>

  <p class="about-text">
		<?php esc_attr_e( 'Congratulations! You are about to use one of the plugins from Wow-Company.', 'herd-effects' ); ?> </p>
  <p>
  ...
  <span class="wow-badge">Wow-Company</span>
	...
	$tabs    = array(
		'wow-plugins' => __( 'Plugins', 'herd-effects' ),
