...
class Button_Group extends \WP_Customize_Control {
	...
	public function render_content() {
		...
		$name     = 'stx_radio_' . $this->id;
		$input_id = 'stx_customize-input-' . $this->id;
		?>
		<div class="stx-button-group">
			<?php
	...
	private function render_control_header() {
		...
		?>
		<div class="stx-button-group-header">
			...
			if ( ! empty( $this->description ) ) {
				?>
				<label class="stx-radio-description-info"
				...
				<span class="stx-radio-hidden-info"><?php echo esc_html( $this->description ); ?></span>
			<?php } ?>
		</div>
		<?php
	}
