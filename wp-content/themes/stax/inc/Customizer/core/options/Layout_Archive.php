...
class Layout_Archive extends Base_Customizer {

	private $section_id = 'stax_layout_archive';
	...
	private function section_container() {
		$this->add_section(
			new Section(
				...
				[
					'priority' => 25,
					'title'    => esc_html__( 'Archive Layout', 'stax' ),
					'panel'    => 'stax_layout',
				]
			)
		);
	...
	/**
	 * Add layout archive control
	 */
	private function control_layout_archive() {
		$this->add_control(
			new Control(
				Config::OPTION_LAYOUT_ARCHIVE,
				[
					'default'           => Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE ]['default'],
					'sanitize_callback' => [ $this, 'sanitize_archive_layout' ],
				],
				[
		...
		$this->add_control(
			new Control(
				Config::OPTION_LAYOUT_ARCHIVE_CONTAINER,
				[
					'default'           => Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE_CONTAINER ]['default'],
					'sanitize_callback' => [ $this, 'sanitize_archive_container_size' ],
				],
				[
		...
		$this->add_control(
			new Control(
				Config::OPTION_LAYOUT_ARCHIVE_STICKY_PRIMARY_SIDEBAR,
				[
					'sanitize_callback' => [ Sanitizer::instance(), 'sanitize_checkbox' ],
					'default'           => Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE_STICKY_PRIMARY_SIDEBAR ]['default'],
				],
				[
		...
		$this->add_control(
			new Control(
				Config::OPTION_LAYOUT_ARCHIVE_STICKY_SECONDARY_SIDEBAR,
				[
					'sanitize_callback' => [ Sanitizer::instance(), 'sanitize_checkbox' ],
					'default'           => Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE_STICKY_SECONDARY_SIDEBAR ]['default'],
				],
				[
		...
		$this->add_control(
			new Control(
				Config::OPTION_LAYOUT_ARCHIVE_SIDEBAR_GAP,
				[
					'sanitize_callback' => [ Sanitizer::instance(), 'sanitize_range_value' ],
					'default'           => Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE_SIDEBAR_GAP ]['default'],
				...
				[
					...
					'input_attrs'     => [
						...
						'max'        => 200,
						'units'      => [ 'px' ],
						'defaultVal' => Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE_SIDEBAR_GAP ]['default'],
					],
					'priority'        => 50,
	...
	public function sanitize_archive_layout( $value ) {
		...
		if ( ! in_array( $value, $allowed_values, true ) ) {
			return Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE ]['default'];
		}
	 ...
	 * @return string
	 */
	public function sanitize_archive_container_size( $value ) {
		$allowed_values = [ 'small', 'large' ];

		if ( ! in_array( $value, $allowed_values, true ) ) {
			return Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE_CONTAINER ]['default'];
		}
	...
	public function if_has_no_sidebar() {
		return in_array( get_theme_mod( Config::OPTION_LAYOUT_ARCHIVE, Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE ]['default'] ), [ 'no-side' ] );
	}
	...
	public function if_has_one_sidebar() {
		return in_array( get_theme_mod( Config::OPTION_LAYOUT_ARCHIVE, Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE ]['default'] ), [ 'sl', 'sr', 'sll', 'srr', 'slr' ] );
	}
	...
	public function if_has_two_sidebars() {
		return in_array( get_theme_mod( Config::OPTION_LAYOUT_ARCHIVE, Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE ]['default'] ), [ 'sll', 'srr', 'slr' ] );
	}
	...
	public function if_has_one_sidebar_and_sticky() {
		return $this->if_has_one_sidebar() &&
			( get_theme_mod( Config::OPTION_LAYOUT_ARCHIVE_STICKY_PRIMARY_SIDEBAR, Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE_STICKY_PRIMARY_SIDEBAR ]['default'] ) ||
			get_theme_mod( Config::OPTION_LAYOUT_ARCHIVE_STICKY_SECONDARY_SIDEBAR, Config::OPTIONS[ Config::OPTION_LAYOUT_ARCHIVE_STICKY_SECONDARY_SIDEBAR ]['default'] ) );
	}
