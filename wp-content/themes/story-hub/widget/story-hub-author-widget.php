...
class Story_Hub_Author_Widget extends WP_Widget
{
     public function __construct()
     {
          parent::__construct(
               'author-widget',
               __( 'TM: Author-Widget', 'story-hub' ),
               array( 'description' => __( 'Best displayed in Sidebar.', 'story-hub' ) )
          );
      }
          ...
          ?>
           ...
           <div class="widget about-author">
                  ...
                  <div class="about-me text-center">
                    <figure class="author"> <img src="<?php echo esc_url( $instance['image_uri'] );?>" alt="about me"></figure>
                    ...
                    <div class="social-icons">
                       ...
                       <?php 
                          ...
                          if ( !empty( $vk ) ) { ?>
                              <li>
                                  <a class="img-circle" href="<?php echo esc_url( $vk ); ?>" data-title="vk " target="_blank"><i class="fa fa-vk"></i></a>
                              </li>
                              <?php
                          }
          ...
          ?>
              <p>
                 ...
                 <input type="text" class="widefat custom_media_url" name="<?php echo $this->get_field_name('image_uri'); ?>" id="<?php echo $this->get_field_id('image_uri'); ?>" value="<?php 
                  ...
                  <input type="button" id="custom_media_button"  value="<?php esc_attr_e( 'Upload Image', 'story-hub' ); ?>" class="button media-image-upload" data-title="<?php esc_attr_e( 'Select Image','story-hub'); ?>" data-button="<?php esc_attr_e( 'Select Image','story-hub'); ?>"/>
                <input type="button" id="remove_media_button" value="<?php esc_attr_e( 'Remove Image', 'story-hub' ); ?>" class="button media-image-remove" />
             </p>
             <p>
                 <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Title', 'story-hub' ); ?></label><br />
             ...
             <p>
                 <label for="<?php echo $this->get_field_id('full_name'); ?>"><?php _e( 'Full Name', 'story-hub' ); ?></label><br />
             ...
             <p>
                 <label for="<?php echo $this->get_field_id('description'); ?>"><?php _e( 'Description', 'story-hub' ); ?></label><br />
              ...
              <p>
                <label for="<?php echo esc_attr( $this->get_field_id('facebook') ); ?>"><?php _e( 'Facebook', 'story-hub' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('twitter') ); ?>"><?php _e( 'Twitter', 'story-hub' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('instagram') ); ?>"><?php _e( 'Instagram', 'story-hub' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('linkedin') ); ?>"><?php _e( 'Linkedin', 'story-hub' ); ?></label><br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('youtube') ); ?>"><?php _e( 'Youtube', 'story-hub' ); ?></label><br />
             ...
             <p>
                <label for="<?php echo esc_attr( $this->get_field_id('vk') ); ?>"><?php _e( 'Vk', 'story-hub' ); ?></label><br />
                <input type="text" name="<?php echo esc_attr( $this->get_field_name('vk') ); ?>" id="<?php echo esc_attr( $this->get_field_id('vk')); ?>" value="<?php
...
add_action( 'widgets_init', 'story_Hub_author_widget' ); 

function story_Hub_author_widget(){ 
    
    register_widget( 'Story_Hub_Author_Widget' );
