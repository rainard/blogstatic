<?php if(!function_exists('magdark_frontpage_editor_post_section')):
...
*
*/
  function magdark_frontpage_editor_post_section()
    {
...
add_action('magdark_action_front_page_editor_section', 'magdark_frontpage_editor_post_section', 30);

//Front Page Banner
if (!function_exists('magdark_front_page_banner_section')) :
    /**
     *
     * @since Mag Dark
     *
     */
    function magdark_front_page_banner_section()
    {
        if (is_front_page() || is_home()) {
        ...
        <?php  } ?>
            <div class="overlay">
                <div class="container-fluid">
                    <div class="row">
                        <?php do_action('magdark_action_front_page_editor_section');?>
                        <div class="col-md-6 col-sm-6">
                            <div id="homemain"class="homemain owl-carousel mr-bot60 pd-r-10"> 
                                <?php newsup_get_block('list', 'banner'); ?>
                            </div>
                        </div> 
                        <?php do_action('magdark_action_banner_tabbed_posts');?>
                    </div>
                </div>
            </div>
        </section>
...
add_action('magdark_action_front_page_main_section_1', 'magdark_front_page_banner_section', 40);



//Banner Tabed Section
if (!function_exists('magdark_banner_tabbed_posts')):
    /**
     *
     * @since Magdark 1.0.0
     *
     */
    function magdark_banner_tabbed_posts()
    {
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#<?php echo esc_attr($tab_id); ?>-recent"
                               aria-controls="<?php esc_attr_e('Recent', 'mag-dark'); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#<?php echo esc_attr($tab_id); ?>-popular"
                               aria-controls="<?php esc_attr_e('Popular', 'mag-dark'); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#<?php echo esc_attr($tab_id); ?>-categorised"
                               aria-controls="<?php esc_attr_e('Categorised', 'mag-dark'); ?>">
...
add_action('magdark_action_banner_tabbed_posts', 'magdark_banner_tabbed_posts', 10);