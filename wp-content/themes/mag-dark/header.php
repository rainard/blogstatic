...
<?php _e( 'Skip to content', 'mag-dark' ); ?></a>
    <div class="wrapper" id="custom-background-css">
        <header class="mg-headwidget">
            <!--==================== TOP BAR ====================-->

            <?php do_action('magdark_action_header_section');  ?>
            ...
            $newsup_header_overlay_color = get_theme_mod('newsup_header_overlay_color','#080808');?> style="background-color:<?php echo esc_attr($newsup_header_overlay_color);?>;" <?php } ?>> 
        ...
        <div class="container-fluid flex-row">
                ...
                <!-- Right nav -->
                    <div class="m-header pl-3 ml-auto my-2 my-lg-0 position-relative align-items-center">
                        ...
                        <!-- navbar-toggle -->
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-wp" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation','mag-dark'); ?>">
...
<?php $show_popular_tags_title = newsup_get_option('show_popular_tags_title');
 ...
 do_action('magdark_action_front_page_main_section_1'); ?>