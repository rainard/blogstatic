...
function moving_company_lite_scripts() {	
	...
	wp_enqueue_script( 'moving-company-lite-custom-scripts-jquery', esc_url(get_template_directory_uri()) . '/assets/js/custom.js', array('jquery') );
	wp_enqueue_script( 'moving-company-lite-jquery-wow', esc_url(get_template_directory_uri()) . '/assets/js/wow.js', array('jquery') );
	wp_enqueue_style( 'moving-company-lite-animate-css', esc_url(get_template_directory_uri()).'/assets/css/animate.css' );
...
function moving_company_lite_tagline_hide_show(){
	if(get_theme_mod('moving_company_lite_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}
