...
class Moving_Company_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Moving_Company_Lite_About_Widget',
			__('VW About us', 'moving-company-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'moving-company-lite' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','moving-company-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','moving-company-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','moving-company-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','moving-company-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','moving-company-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','moving-company-lite'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function moving_company_lite_about_custom_load_widget() {
	register_widget( 'Moving_Company_Lite_About_Widget' );
}
add_action( 'widgets_init', 'moving_company_lite_about_custom_load_widget' );