jQuery(document).ready(function($) {
    'use strict';
    var this_obj = moving_company_lite_plugin_activate_plugin;
    ...
    $(document).on('click', '.moving-company-lite-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message moving-company-lite-plugin-install');
                button.addClass('button-primary moving-company-lite-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.moving-company-lite-recommended-plugins .moving-company-lite-activation-note').css('display','block');
    ...
    $(document).on('click', '.moving-company-lite-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .moving-company-lite-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .moving-company-lite-recommended-plugins').css('display','none');
    });
