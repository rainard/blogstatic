  ...
  <footer role="contentinfo">
    <div id="footer" class="copyright-wrapper">
      <div class="container">
          ...
          ?>
          <div class="row">
            <div class="wow slideInUp delay-1000 <?php if ( !is_active_sidebar( 'footer-1' ) ){ echo "footer_hide"; }else{ echo "$colmd"; } ?> col-xs-12 footer-block">
            ...
            <div class="wow slideInDown delay-1000 <?php if ( is_active_sidebar( 'footer-3' ) ){ echo "$colmd"; }else{ echo "footer_hide"; } ?> col-xs-12 col-xs-12 footer-block">
    ...
    <div id="footer-2">
        ...
        <p><?php moving_company_lite_credit(); ?> <?php echo esc_html(get_theme_mod('moving_company_lite_footer_text',__('By VWThemes','moving-company-lite'))); ?></p>
        <?php if( get_theme_mod( 'moving_company_lite_hide_show_scroll',true) != '' || get_theme_mod( 'moving_company_lite_resp_scroll_top_hide_show',true) != '') { ?>
