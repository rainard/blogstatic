...
if ( ! function_exists( 'lalita_get_color_defaults' ) ) {
	...
	function lalita_get_color_defaults() {
		$lalita_color_defaults = array(
			...
			'subnavigation_text_color' => '#f2d8c1',
			...
			'fixed_side_content_background_color' => 'rgba(17,17,17,0)',
			'fixed_side_content_text_color' => '#f2d8c1',
			'fixed_side_content_link_color' => '#f2d8c1',
			...
			'blog_header_title_color' => '#f2d8c1',
			'blog_header_text_color' => '#ffffff',
			'blog_header_button' => '#111111',
			'blog_header_button_bg' => '#f2d8c1',
			'blog_header_button_hover' => '#111111',
			...
			'sidebar_widget_link_color' => '#f2d8c1',
			'sidebar_widget_link_hover_color' => '#ffffff',
			'sidebar_widget_title_color' => '#ffffff',
			'footer_widget_background_color' => 'rgba(17,17,17,0)',
			'footer_widget_text_color' => '#ffffff',
			'footer_widget_link_color' => '#f2d8c1',
			'footer_widget_link_hover_color' => '#ffffff',
			'footer_widget_title_color' => '#ffffff',
			'footer_background_color' => 'rgba(17,17,17,0)',
			'footer_text_color' => '#ffffff',
			'footer_link_color' => '#f2d8c1',
...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			...
			'font_fixed_side_variants' => 'regular,700,900',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Playfair+Display:regular,700,900|Roboto+Slab:100,300,regular,700' );
