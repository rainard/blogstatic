...
function advance_pet_care_logo_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('advance_pet_care_site_title_size_option',array(
		'default'	=> 37,
		'sanitize_callback'	=> 'advance_pet_care_sanitize_float'
	));
	$wp_customize->add_control('advance_pet_care_site_title_size_option',array(
		'label'	=> __('Site Title Size option','advance-pet-care'),
		'section'	=> 'title_tagline',
		'setting'	=> 'advance_pet_care_site_title_size_option',
		'type'	=> 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
    ...
    $wp_customize->add_setting('advance_pet_care_site_tagline_size_option',array(
		'default'	=> 13,
		'sanitize_callback'	=> 'advance_pet_care_sanitize_float'
	));
	$wp_customize->add_control('advance_pet_care_site_tagline_size_option',array(
		'label'	=> __('Site Tagline Size option','advance-pet-care'),
		'section'	=> 'title_tagline',
		'setting'	=> 'advance_pet_care_site_tagline_size_option',
		'type'	=> 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 0,
