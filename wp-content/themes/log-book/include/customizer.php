...
function log_book_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting(
        'log_book_breadcrumb_setting_option',
        array(
                'default'           => $default['log_book_breadcrumb_setting_option'],
                'sanitize_callback' => 'log_book_sanitize_select',

             )
    );
 
    $wp_customize->add_control('log_book_breadcrumb_setting_option',
        array(
                 'label'       => esc_html__('Breadcrumb Options', 'log-book'),
                 'description' => sprintf( esc_html__( 'Advanced: Requires %1$sRank MathXT%2$s plugin','log-book'), '<a href="https://wordpress.org/plugins/seo-by-rank-math/" target="_blank">','</a>' ),
                 'section'     => 'section_breadcrumb',
                'choices' => array(
                                'simple'    => esc_html__( 'Theme Default','log-book'),
                                'advanced'  => esc_html__( 'Advanced : Breadcrumb NavXT','log-book'),
                                'rank-math' => esc_html__( 'Rank Math : Breadcrumb','log-book'),
                                'yoast-seo' => esc_html__( 'Yoast Seo : Breadcrumb','log-book'),
...
if ( ! function_exists( 'log_book_default_theme_options' ) ) :
	...
	function log_book_default_theme_options() {
		...
		$defaults['log_book_breadcrumb_setting_option']            = 'simple';
