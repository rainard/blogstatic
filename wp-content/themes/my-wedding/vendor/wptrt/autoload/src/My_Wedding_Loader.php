...
class My_Wedding_Loader {
	 ...
	 * @return void
	 */
	public function my_wedding_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function my_wedding_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function my_wedding_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function my_wedding_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->my_wedding_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function my_wedding_load( $class ) {
