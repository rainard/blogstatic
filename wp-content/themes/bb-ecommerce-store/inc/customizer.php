...
function bb_ecommerce_store_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'bb_ecommerce_store_loader_background_color_settings', array(
	    'default' => '#222',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'bb_ecommerce_store_loader_background_color_settings', array(
  		'label' => __('Preloader Background Color', 'bb-ecommerce-store'),
	    'section' => 'bb_ecommerce_store_left_right',
	    'settings' => 'bb_ecommerce_store_loader_background_color_settings',
  	)));
