<?php
	...
	$bb_ecommerce_store_loader_background_color_settings = get_theme_mod('bb_ecommerce_store_loader_background_color_settings');
	$bb_ecommerce_store_custom_css .='#loader-wrapper .loader-section{';
		$bb_ecommerce_store_custom_css .='background-color: '.esc_attr($bb_ecommerce_store_loader_background_color_settings).';';
	$bb_ecommerce_store_custom_css .='} ';
